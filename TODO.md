...
- [x] **VIS-01 (Segmentación Morfológica de Firmas y Sellos en Imágenes Puras):** Incorporar detección de componentes conexos y análisis de contornos en OpenCV para segmentar firmas y sellos en imágenes `.png`, `.jpg` y `.tiff` donde `page.get_images()` solo reporta el lienzo completo. (Resuelto: detección visual 100% en escaneos e imágenes).
